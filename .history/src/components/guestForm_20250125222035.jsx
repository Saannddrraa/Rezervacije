      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <div className="form-group">
          ...
          <select 
            ...
            onChange={(e) => {
              ...
              setRoomType(""); // Resetuje izbor sobe/apartmana
            }}
          >
        ...
        <div className="form-group">
          ...
          <select 
            ...
            disabled={!accommodationType} // Onemogućeno dok nije odabran tip smeštaja
          >
        ...
        {/* Submit Button */}
        <div className="form-group">
          <button type="submit" disabled={!roomType}>Zabeleži</button>
        </div>
      </form>
    </div>
  );
